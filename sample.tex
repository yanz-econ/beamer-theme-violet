...
\title[Short Title]{A Minimized Violet Beamer Theme}
\subtitle{An Optional Subtitle for the Presentation}
\author[Yan]{
    Yan \\ 
    \vspace{0.2cm}
    \footnotesize
    \href{mailto:yanzhuang2026@outlook.com}{\texttt{yanzhuang2026@outlook.com}} \\
    \href{https://yanz-econ.github.io/}{\texttt{yanz-econ.github.io}}
}
...
\begin{frame}{Background and Motivation}
    \begin{itemize}
        \item Your background and motivation.
        \item If you set \texttt{XeLaTeX} as the compiler, you can use Chinese characters.
        \item 中文字体为楷体.
    \end{itemize}
...
\begin{frame}{Main Regression Output}
    \begin{table}
        ...
        \begin{tablenotes}
            \footnotesize
            \textit{Notes:} Standard errors clustered at the group level in parentheses. *** p$<$0.01, ** p$<$0.05, * p$<$0.1.
        \end{tablenotes}
    \end{table}
\end{frame}
